...
A fairly extension and varying collection of test data were used in the development and testing of the algorithm. Most of these are captured in the `test_data` directory. It contains the original data I used in the article and additional data. Also provided in that directory's [README](https://mikecsplayplace.github.io/CubicSplineExtrema/test_data/README.md) are detailed explanations of the input data, expected output data, results, and some pretty plots.
