                       ...
                       struct point *extr)       /* output - singly linked list of extrema */
{
    ...
    sec_deriv = (float*)malloc(num_pnts * sizeof(float));
                       ...
                       float *sec_deriv)         /* output - array of 2nd derivatives of intervals */
{
    ...
    main_diag = (float*)malloc((num_pnts - 2) * sizeof(float));
    diag = (float*)malloc((num_pnts - 1) * sizeof(float));
    right = (float*)malloc((num_pnts - 2) * sizeof(float));
